...
class ThemeColors {
  ...
  static const listTileTrailingIcon = Colors.redAccent;
  static const buttonBackground = Colors.redAccent;
  static const progressBar = Colors.redAccent;
  static const progressBarBackground = Color(0xFFf0f2f5);

  // text
  static const textColor1 = Color(0xffffffff);
  static const textColor2 = Color(0xff0c0d0d);
}